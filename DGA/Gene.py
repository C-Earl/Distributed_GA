...
class Gene:
  ...
  def crossover(self, params_list: list[Parameters], **kwargs) -> any:
    return self.crossover_(params_list, **kwargs)
  ...
  def crossover(self, parents: list[Parameters], iteration: int) -> Parameters:
    ...
    for gene_name, gene in self.items():
      ...
      if gene.crossover_:
        ...
        new_params[gene_name] = gene.crossover(parent_genes, **crossover_args)
